...
export default function Sidebar({ currentView, setCurrentView, user }) {
  ...
  const navItems = [
    ...
    { name: 'Mis Activos', view: 'activos', icon: icons.activos }, // ✅ NUEVO ÍTEM
  ];

   return (
    <div className={`transition-width duration-300 ease-in-out bg-white shadow-lg flex flex-col h-full border-r border-gray-200 ${isCollapsed ? 'w-20' : 'w-64'}`}>
